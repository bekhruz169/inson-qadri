...
/**
 * Project detail page - Loyiha tafsilotlari
 * Features smooth animations and immersive viewing experience
 */
            ...
            <div className="grid md:grid-cols-2 gap-6 pt-4">
              {project.views && (
                <div className="space-y-2">
                  ...
                  <p className="font-light text-foreground">{project.views}</p>
                </div>
              )}
              {project.client && (
                <div className="space-y-2">
